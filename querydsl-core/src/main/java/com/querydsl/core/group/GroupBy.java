...
public final class GroupBy {
     ...
     * @return
     */
    public static <K extends java.lang.Object> GroupByBuilder<K> groupBy(Expression<K> key) {
     ...
     * @return
     */
    public static <E extends java.lang.Object> AbstractGroupExpression<E, List<E>> list(Expression<E> expression) {
        return new GList<E>(expression);
    }

    public static <E extends java.lang.Object, F extends java.lang.Object> AbstractGroupExpression<E, List<F>> list(GroupExpression<E, F> groupExpression) {
     ...
     * @return
     */
    public static <E extends java.lang.Object> AbstractGroupExpression<E, Set<E>> set(Expression<E> expression) {
        return GSet.createLinked(expression);
    }

    public static <E extends java.lang.Object, F extends java.lang.Object> GroupExpression<E, Set<F>> set(GroupExpression<E, F> groupExpression) {
     ...
     * @return
     */
    public static <K extends java.lang.Object, V extends java.lang.Object> AbstractGroupExpression<Pair<K, V>, Map<K, V>> map(Expression<K> key, Expression<V> value) {
        return GMap.createLinked(QPair.create(key, value));
    }

    public static <K extends java.lang.Object, V extends java.lang.Object, T extends java.lang.Object> AbstractGroupExpression<Pair<K, V>, Map<T, V>> map(GroupExpression<K, T> key, Expression<V> value) {
        return map(key, new GOne<V>(value));
    }

    public static <K extends java.lang.Object, V extends java.lang.Object, U extends java.lang.Object> AbstractGroupExpression<Pair<K, V>, Map<K, U>> map(Expression<K> key, GroupExpression<V, U> value) {
        return map(new GOne<K>(key), value);
    }

    public static <K extends java.lang.Object, V extends java.lang.Object, T extends java.lang.Object, U extends java.lang.Object> AbstractGroupExpression<Pair<K, V>, Map<T, U>> map(GroupExpression<K, T> key, GroupExpression<V, U> value) {
